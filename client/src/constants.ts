...
export const MOCK_REVIEWS: Review[] = [
  {
    ...
    content: 'Methodology is sound overall. Section 4 needs clearer assumptions for the validator churn model.',
    rating: 4,
    stakeAmount: 100,
    date: '2024-01-15',
    status: 'confirmed',
  },
  {
    ...
    content: 'Benchmarks are promising; please include confidence intervals and baseline parameter tables.',
    rating: 3,
    stakeAmount: 100,
    date: '2024-01-16',
    status: 'confirmed',
  },
  {
    ...
    content: 'Conclusions overstate resistance to collusion. Additional adversarial simulations are required.',
    rating: 2,
    stakeAmount: 100,
    date: '2024-01-17',
    status: 'slashed',
