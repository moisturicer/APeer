...
const STATS = [
  ...
  { label: 'peerA Earned', val: '45,200', isToken: true },
  { label: 'Disputes Won', val: '4' },
];

export function ProfilePage({ papers, onPublish }: ProfilePageProps) {
  return (
        ...
        <aside>
          <div className="bg-[color:var(--color-surface)] border border-[color:var(--color-border)] rounded-2xl p-8 mb-6 sticky top-24">
            ...
            <div className="text-center mb-8">
              <h2 className="text-xl font-bold text-zinc-900 mb-1">Dr. S. Nakamoto</h2>
              <p className="text-xs font-mono text-zinc-400 mb-6">addr1...y8xw3p09k</p>
            ...
            <div className="flex flex-wrap gap-2 mb-8">
              <Badge variant="teal">Platinum Reviewer</Badge>
              <Badge variant="amber">Top Citations 2024</Badge>
              <Badge variant="gray">Cardano OG</Badge>
            </div>
